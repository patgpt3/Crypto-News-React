...
const CryptoSelectedComment: React.FC = () => {
  ...
  const API_URL = `https://toptop-api-facbf95cbd23.herokuapp.com/reply/${id}`;
  ...
  const handleVoteComment = async (id: string, isUpvote: boolean) => {
    const url = `https://toptop-api-facbf95cbd23.herokuapp.com/reply/${
    ...
    try {
      const response = await fetch(
        `https://toptop-api-facbf95cbd23.herokuapp.com/reply/${id}`,
      ...
      <td className="default">
        <div style={{ marginTop: "2px", marginBottom: "-10px" }}>
          <span className="comhead">
            ...
            >
              | {users? users.author : "" === currentCommentMap ? "delete?" : "flag?"}
            </a>{" "}
            <a
