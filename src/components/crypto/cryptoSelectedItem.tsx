...
// React component
const CryptoSelectedItem: React.FC = () => {
  ...
  const API_URL = `https://toptop-api-facbf95cbd23.herokuapp.com/items/${id}`;
            ...
            <React.Fragment key={users?._id}>
                ...
                <td className="title">
                  ...
                  >
                    ...
                    <span style={{ fontSize: "11px", color: "black" }}>
                      <img
                        onClick={() =>
                          handleVote(users ? users?._id : "", true)
                        }
                    ...
                    <a style={{ color: "black" }} href={users?.url}>
                      {users?.title}
                    </a>
                    <span className="sitebit comhead">
                      {users?.url &&
                        stripToDomain(users?.url) &&
                        `(${stripToDomain(users?.url)})`}
                    </span>
                  </span>
                </td>
              ...
              <tr>
                <td colSpan={2}>
                  ...
                  >
                    <span className="score">{users?.points} points</span> | by{" "}
                    <a
                      className="cnUser"
                    ...
                    <span className="age" title={users?.createdAt}>
                      | {timeSince(new Date(users ? users?.createdAt : ""))}
                    </span>{" "}
                    <a
                    ...
                    >
                      |{" "}
                      {users?.author === localStorage.getItem("username")
                        ? "delete?"
                        : "flag?"}
                    </a>{" "}
                    <a
                      ...
                      onClick={() => handleVote(users ? users?._id : "", false)}
...
export default CryptoSelectedItem;
