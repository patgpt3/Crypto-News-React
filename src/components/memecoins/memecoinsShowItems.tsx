...
const API_URL =
  "https://toptop-api-facbf95cbd23.herokuapp.com/items/show/pages/cat";
...
// React component
const MemecoinsShowItems: React.FC = () => {
  ...
  commentElements.forEach((commentElement) => {
    commentElement.addEventListener("click", () => {
      ...
      window.location.href = `/memecoins/item/${itemId}`;
    });
  });
...
export default MemecoinsShowItems;
