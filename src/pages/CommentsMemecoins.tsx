...
import CommentsMemecoins from "../components/memecoins/memecoinsCommentItems2";
import HeaderMain from "./header";

function CommentsPageMemecoins() {
                    ...
                    <tr>
                      <td style={{ lineHeight: "12pt", height: "18px" }}>
                        <span className="pagetop" style={{ color: "white" }}>
                          ...
                          <a href="/memecoins/new" style={{ color: "white" }}>
                            new
                          </a>{" "}
                          |{" "}
                          <a style={{ color: "white" }} href="/memecoins/comments">
                            comments
                          </a>{" "}
                          |{" "}
                          <a style={{ color: "white" }} href="/memecoins/ask">
                            ask
                          </a>{" "}
                          |{" "}
                          <a style={{ color: "white" }} href="/memecoins/show">
                            show
                          </a>{" "}
                          |{" "}
                          <a style={{ color: "white" }} href="/memecoins/jobs">
                            jobs
                          </a>{" "}
                          |{" "}
                          <a
...
export default CommentsPageMemecoins;
